...
const Scanner = () => {
  ...
  return (
    <div className="h-[80vh] flex flex-col items-center justify-center text-center">
      <div className="bg-white p-12 rounded-3xl shadow-xl border border-slate-200 max-w-2xl w-full relative overflow-hidden">
        ...
        <h2 className="text-3xl font-bold text-slate-900 mb-4">Modo de Leitura Ativo</h2>
